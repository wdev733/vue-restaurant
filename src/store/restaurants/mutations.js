const mutations = {
  ...
  toggleOpenDetailsModal: state =>
    (state.modals.openDetailsModal = !state.modals.openDetailsModal),
  toggleOpenUpdateModal: state =>
    (state.modals.openUpdateModal = !state.modals.openUpdateModal),
  setImageCurrentRestaurant: (state, payload) =>
    (state.imageCurrentRestaurant = payload)
};
